...
class VerticalMasonriesForVideosContainer extends Component {
	constructor(props) {
		super(props);
// STATE	
		this.state = {
...
VerticalMasonriesForVideosContainer.defaultProps = {
	// elements:
...
export default withResponsiveness(withStyles(styles)(VerticalMasonriesForVideosContainer));
