...
// STATE	
	...
	fetchAllLike(endpoint) {
		...
		axios.get(utils.baseUrl + '/pages/get-all-interest-in-page', 
			{
			    params: {
					endpoint: endpoint,
					child_count: 3,
...
// export default ShowLikesOfPage; // REMOVE withResponsiveness and withStyles as much as possible
export default withResponsiveness(ShowLikesOfPage)