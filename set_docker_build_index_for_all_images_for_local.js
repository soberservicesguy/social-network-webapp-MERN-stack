...
async function set_docker_build_index_for_all_images_for_local(){
...
async function get_deployment_file_base_names(docker_images){
	...
	docker_images = await set_docker_build_index_for_all_images_for_local()
	console.log({docker_images})
...
async function set_docker_image_in_deployment_file(deployment_file_base_names){
	...
	deployment_file_base_names.map(async (file_base_name_dict) => {
		console.log({file_base_name_dict})
...
module.exports = set_docker_build_index_for_all_images_for_local