module.exports.isAllowedCreatingSports = (req, res, next) => {
    ...
    // check user privilege
        ...
        let required_privilege = req.user.user_object.privileges.filter(
            function(privilege_object){
                return privilege_object.privilege_name === 'allow_sport_creating'
            }
        )
        ...
        if (required_privilege){
            ...
            res.status(401).json({ msg: 'isAllowedCreatingSports Privilege missing' });            
