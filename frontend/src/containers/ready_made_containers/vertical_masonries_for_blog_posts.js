...
class VerticalMasonriesForBlogPostsContainer extends Component {
	constructor(props) {
		super(props);
// STATE	
		this.state = {
					...
					{this.props.vertical_grid_details.map(
						...
						(grid_detail_item, outer_index) => (
							...
							<Grid item container direction="column" 
								...
								// spacing={grid_detail_item.vertical_spacing / 5}
								xs={12} sm={12} 
									...
									(masonry_detail_item, inner_index) => (
										<Grid item
											style={{
												...
												margin:( _xs | _sm | _md ) ? 'auto' : 'none',
												marginLeft:( _xs | _sm | _md ) ? 'none' : grid_detail_item.gap / 2,
												marginRight:( _xs | _sm | _md ) ? 'none' : grid_detail_item.gap / 2,
											}}
										>
											<BlogCard
												// height={grid_detail_item.height}
											/>
										</Grid>
// above is compact than below
									// ( _xs | _sm | _md ) 
									// 	?
									// 		<Grid item
									// 			style={{
									...
									// 				height:masonry_detail_item.height,
									// 				marginBottom:grid_detail_item.vertical_spacing,
									// 				marginLeft:grid_detail_item.gap / 2,
									// 				marginRight:grid_detail_item.gap / 2,
									// 			}}
									// 		>
									// 			<BlogCard
									// 				// height={grid_detail_item.height}
...
VerticalMasonriesForBlogPostsContainer.defaultProps = {
	// elements:
	vertical_grid_details:[ 
		{row_grids:4, vertical_spacing:10, gap:10, heights:[
		...
		// {row_grids:3, vertical_spacing:10, gap:10, heights:[
		// 		{height:'none'}, {height:'none'}
		// 	]
		// }, 
	],
...
export default withResponsiveness(withStyles(styles)(VerticalMasonriesForBlogPostsContainer));
